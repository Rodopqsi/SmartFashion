...
export function AuthProvider({ children }) {
  ...
  return <AuthContext.Provider value={{ user, tokens, login, register, verifyEmail, logout, googleLogin, completeGoogleUsername, requestPasswordReset, verifyPasswordReset, fetchWithAuth, setUser: saveUser }}>{children}</AuthContext.Provider>
}
