...
const card = { border:'1px solid #eee', borderRadius:10, padding:10, cursor:'pointer' }
const badge = { display:'inline-block', marginTop:6, fontSize:10, background:'#eef2ff', color:'#3730a3', padding:'2px 6px', borderRadius:6 }
const btnSecondary = { padding:'6px 10px', border:'1px solid #ddd', background:'#fff', color:'#111', borderRadius:8, fontWeight:600, cursor:'pointer' }
