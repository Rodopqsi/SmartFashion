    ...
    for m in pattern.finditer(s):
        ...
        for line in body.splitlines():
            ...
            if colm:
                ...
                # remove trailing COMMENTs for cleaner compare
...
def normalize_type(t):
    # lowercase, remove charset/collate, remove unsigned? keep numeric precision
    t = t.lower()
    # remove 'unsigned' keyword placement - keep it but normalize spacing
