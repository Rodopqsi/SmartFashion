    ...
    try:
        ...
        try:
            ...
            if r.ok:
                ...
                # Fallback: if admin webhook is rejected, try to create a local Envio record
                try:
                    from django.db import connection as _conn
                    with _conn.cursor() as _c:
                        # pick a distribution center if available
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    pass
                # If admin returned non-OK, create a local Envio as fallback (if a center exists)
                try:
