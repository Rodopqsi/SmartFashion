...
export default function Catalog() {
  ...
  // Image loading/error handlers: add a 'loading' class while loading and replace broken images with a dark SVG placeholder
  useEffect(() => {
    const handleImages = () => {
      const imgs = document.querySelectorAll('.products-grid img')
      imgs.forEach(img => {
        // mark as loading until load/error fires
        ...
        // If already complete but naturalWidth is 0, trigger error handler
        if (img.complete && img.naturalWidth === 0) {
          onError()
        }
      })
    }
    // run initially and after a short delay to catch dynamic images
    handleImages()
      ...
      <div className="catalog-top">
        ...
        <aside style={leftColStyle}>
          <div className="filters-group" style={filtersGroup}>
            ...
            <div className="section-title" style={sectionTitle}>Categorías</div>
            <div className="chips-wrap" style={chipsWrap}>
            ...
            <div className="section-title" style={sectionTitle}>Tallas</div>
            <div className="chips-wrap" style={chipsWrap}>
            ...
            <div className="section-title" style={sectionTitle}>Colores</div>
            <div className="chips-wrap" style={chipsWrap}>
            ...
            <div className="section-title" style={sectionTitle}>Precios</div>
            <div className="chips-wrap" style={chipsWrap}>
